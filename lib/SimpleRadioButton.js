...
export class RadioButton extends React.Component {
  ...
  render () {
    ...
    return (
      <View accessibilityLiveRegion={"assertive"} accessibilityComponentType={this.props.isSelected ? "radiobutton_checked" : "radiobutton_unchecked"} accessible={true} accessibilityLabel={this.props.obj.label} style={this.props.wrapStyle}>
        {renderContent}
      </View>
    )
  }
